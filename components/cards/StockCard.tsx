    ...
    >
      ...
      <div className="flex justify-between items-start mb-1">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-neutral bg-surface-2 px-1.5 py-0.5 rounded">Stock</span>
        </div>
        <span className="text-[10px] text-text-muted">{holding.shares} shares</span>
      </div>
